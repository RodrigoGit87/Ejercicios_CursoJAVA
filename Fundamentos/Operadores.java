...
public class Operadores {
    public static void main() {
        ...
        var a = 5;
        var b = 3; // En el momento q una de las variables es de tipo real (double en java), ya el
                   // resultado lo
        ...
        // comparan el valor de una variable con otra variable o con otro dato, y lo
        // imprime como true o false)
        IO.println("a == b: " + (a == b)); // Es falso por que el ultimo valor que se asigno a 'a' fue 0 y 'b' sigue
                                           // valiendo 3)
        // lo comprobamos->
